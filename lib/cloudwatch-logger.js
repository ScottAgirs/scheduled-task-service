...
const { HUMAN_READABLE_INTERVAL } = require("..");
...
async function initializeCloudWatchLogs(streamName = "default") {
  try {
    ...
    console.log(`✅ CloudWatch logging initialized for ${LOG_GROUP_NAME}/${streamName} and ${ERROR_LOG_GROUP_NAME}/${streamName}. Every ${HUMAN_READABLE_INTERVAL} minutes`);
  } catch (error) {
